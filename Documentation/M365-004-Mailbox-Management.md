...
![Full Access Delegate Configured](../Screenshots/M365-004-Mailbox-Management/01-Full-Access-Delegate-Configured.png)
...
![Mailbox Permissions Successfully Added](../Screenshots/M365-004-Mailbox-Management/02-Mailbox-Permissions-Successfully-Added.png)
...
![Send As Delegate Configured](../Screenshots/M365-004-Mailbox-Management/03-Send-As-Delegate-Configured.png)
...
![Send As Permission Successfully Added](../Screenshots/M365-004-Mailbox-Management/04-Send-As-Permission-Successfully-Added.png)
...
![Mailbox Delegation Permissions Verified](../Screenshots/M365-004-Mailbox-Management/05-Mailbox-Delegation-Permissions-Verified.png)
...
By assigning **Read and Manage (Full Access)** and **Send As** permissions, the delegate was provided with the necessary access to manage the user's mailbox and send email using the mailbox owner's identity.
